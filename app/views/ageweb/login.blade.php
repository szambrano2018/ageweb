        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <form action="verificalogin" method="post" id="formlogin" name="formlogin">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="str_usuario" name="str_usuario" placeholder="example@gmail.com">
                                <span style="color: #ff3346 ;">{{$errors->first("str_usuario")}}</span>
                            </div>
                            <div class="form-group">
                                <label for="password" class="control-label">Contraseña</label>
                                <input type="password" class="form-control" id="password" name="password" maxlength="8">
                                <span style="color: #ff3346 ;">{{$errors->first("password")}}</span>
                            </div>
                            <div class="checkbox">
                                <label>
